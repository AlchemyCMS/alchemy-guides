...
The following steps use the orbit slider provided by "Foundation Zurb":http://foundation.zurb.com/docs/components/orbit.html (© ZURB, Inc).
...
Open the editor partial <code>_slider_edit.html.erb</code> in <code>app/views/alchemy/elements</code> and edit to:
