...
The following steps use the orbit slider provided by "Foundation Zurb":http://foundation.zurb.com/docs/components/orbit.html .
...
Add the following lines to your <code>applicaion.js</code> in
...
First of all we define the slider element(in <code>config/alchemy/</code>)
...
Run the command
<shell>rails g alchemy:elements -skipp</shell>
...
In this view partial we use a loop, in order to iterate above the picture in the gallery.
We use render_essence_view to render the image (See "documentation":http://rubydoc.info/github/magiclabs/alchemy_cms/Alchemy/EssencesHelper for further information).
...
Open the editor partial <code>_slider_edit.html.erb</code> in <code>app/views/alchemy/elements</code>:
and edit to:
...
and create new page layout file <code>_intro.html.erb</code> in <code>app/views/alchemy/page_layouts</code>.

h3. Embed the slider in your page layout

After defining the 'slider' element you can integrate it in the page layout.
