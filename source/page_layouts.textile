...
Every page in Alchemy depends on a page layout.

Think of page layout as types of pages. They are used to give certain pages abilities, like available elements, caching settings, enable xml feeds, and so on.
...
Follow this guide to learn how to "create page layouts":creating_page_layouts.html which than can be chosen by the user while creating a new page.
