...
= element_view_for(element) do |el|
  #gallery
    - element.contents.gallery_pictures.each do |image|
      = render_essence_view(image, :image_size => "346x246")
  .caption
    = el.render :caption
  .show_caption
...
Alternatively, if you want to customize the way the gallery pictures are rendered, you may use the Alchemy Picutre Url Helper:
<code>image_tag show_alchemy_picture_url(image.essence.picture, :image_size => "102x73", :format => "png")</code>
