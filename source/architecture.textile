...
Since Alchemy v2.1 there is a ressources controller available. When developing own modules for Alchemy, your controller can inherit from that ressources controller (<code>Alchemy::Admin::RessourcesController</code>) and will get all the rails-like CRUD methods.
...
Read more details of the ressources controller in the "module development":create_modules.html guide.
