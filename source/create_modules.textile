...
More information about authorization can be found in the docs of the <code>declarative_authorization</code> gem ("http://rubydoc.info/github/stffn/declarative_authorization/file/README.rdoc":http://rubydoc.info/github/stffn/declarative_authorization/file/README.rdoc#Authorization_Rules)
...
NOTE: As an alternative to the module icon you can pass: <br><code>image: '/assets/icon_of_your_module.png'</code>
