...
If you want to store the value in another column, please use one of "the various options":http://rubydoc.info/github/magiclabs/alchemy_cms/Alchemy/Essence/ClassMethods:acts_as_essence the <code>acts_as_essence</code> class method provides.
