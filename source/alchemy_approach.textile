h2. How to work with Alchemy CMS

This guide covers some general strategy for using Alchemy.

* Conceptional structuring
...
"Best Practice: Create a (contact) Form":best_practice_create_form.html
